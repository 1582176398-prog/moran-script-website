...
const storyData = {
    ...
    xia_wan_chapter1: {
        ...
        scenes: [
            // --- 节点1.1:初来乍到 ---
            {
                ...
                choices: [
                    { text: '那就玩推理本吧', next: 'xw_1_1_a', affinity: { xiao_tong: 40 }, friendship: {} },
            ...
            // --- 虹猫搭话·选择反馈（推理本）---
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'su_xinyue', text: '"两年多啦~从大一就开始了。"' },
                    { speaker: 'xia_wan', text: '"这么久？"' },
                    { speaker: 'su_xinyue', text: '（笑了笑）"嗯，算是店里的老员工了~"' },
                    { speaker: 'narrator', text: '她说这话的时候，语气里带着一点骄傲。' },
                    { speaker: 'xia_wan', text: '（两年……她大三，那是从入学就开始了？）' }
                ],
                choices: [],
                next: 'xw_1_2_continue_mystery'
            },
    ...
    xia_wan_chapter2_extend: {
        ...
        scenes: [
            ...
            // =============================================
            {
                ...
                choices: [
                    { text: '认真观察橙子的带本方式', next: 'xw_2_10_a', affinity: { chengzi: 3 }, friendship: { chengzi: 5 } },
            ...
            // =============================================
            {
                ...
                choices: [
                    { text: '和方圆聊游戏', next: 'xw_2_12_ganzhiyu', affinity: { gan_zhiyu: 5 }, friendship: { gan_zhiyu: 0 } },
            ...
            // =============================================
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'xia_wan', text: '方圆，我帮你做什么？' },
            ...
            // --- 场景15a：留下来 ---
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'xia_wan', text: '（方圆好像...和我想象的不太一样。）' },
            ...
            // --- 场景15b：先回去 ---
            {
                ...
                background: 'bg-street',
                dialogues: [
                    { speaker: 'xia_wan', text: '那...方圆辛苦了，我先回去了。' },
                    ...
                    { speaker: 'xia_wan', text: '（方圆...每天都这么晚下班吗？）' },
        ...
        scenes: [
            ...
            // --- 场景5b：算了不敢 ---
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'xia_wan', text: '（他只是把我当学妹而已...）' },
            ...
            // =============================================
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'xia_wan', text: '（等等...他说的是"失去"...）' },
                    { speaker: 'xia_wan', text: '（那岂不是说...他一直把我当作很重要的人？）' },
                    { speaker: 'narrator', text: '就在这时，手机突然亮了。是木星发来的消息。' },
                    { speaker: 'xiao_tong', text: '「还没睡？」' },
                    { speaker: 'xia_wan', text: '！（心跳漏了一拍）' },
                    { speaker: 'xiao_tong', text: '「睡不着。今天的事...我想了很久。」' },
                    { speaker: 'xiao_tong', text: '「有些话，我想当面跟你说。」' },
                    { speaker: 'xiao_tong', text: '「明天...能早点来店里吗？」' },
                    { speaker: 'xia_wan', text: '「好。」' },
                    { speaker: 'narrator', text: '夏晚盯着屏幕，心跳如鼓。' },
                    { speaker: 'xia_wan', text: '（他想说什么...该不会是我想的那样吧...）' },
                    { speaker: 'narrator', text: '她把手机贴在胸口，闭上眼睛。' },
                    { speaker: 'xia_wan', text: '（木星...明天...会有答案吗...）' },
                    { speaker: 'narrator', text: '窗外，月光温柔地洒落。' },
                    { speaker: 'narrator', text: '夏晚知道，属于她的夏天，才刚刚开始。' },
                    { speaker: 'narrator', text: '...' },
                    { speaker: 'narrator', text: '与此同时，在城市的另一边。' },
                    { speaker: 'narrator', text: '木星站在窗边，看着夜空。' },
                    { speaker: 'narrator', text: '手里握着的，是夏晚当初还给他的那把伞。' },
                    { speaker: 'xiao_tong', text: '（不想失去...吗...原来...我一直都很在意她。）' },
                    { speaker: 'xiao_tong', text: '（也许...明天就是时候了。）' },
                    { speaker: 'narrator', text: '两个人，各怀心事。却都在期待着，明天的到来。' },
                    { speaker: 'narrator', text: '...' },
                    { speaker: 'narrator', text: '夏天已经过去了一半。而属于夏晚和木星的故事...' },
                    { speaker: 'narrator', text: '即将迎来新的篇章...' },
            ...
            // =============================================
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'xia_wan', text: '（木星对我好，可能只是因为我是他的学妹。）' },
                    ...
                    { speaker: 'xiao_tong', text: '（毕竟...她是我的学妹。）' },
    ...
    xia_wan_chapter3_longxinheng: {
        ...
        scenes: [
            ...
            // --- 场景2a：走过去关心 ---
            {
                ...
                choices: [
                    { text: '认真地看着他，告诉他「我懂」', next: 'xw_3_lr_2_a_detail', affinity: { long_xinheng: 8 }, friendship: { long_xinheng: 5 }, confessionCondition: 'longxinheng' },
                    { text: '安静地笑了笑，轻声说「早点休息」', next: 'xw_3_lr_3', affinity: { long_xinheng: 3 }, friendship: { long_xinheng: 3 } }
                ]
            },
            // --- 场景2a_detail：认真感受他的孤独（触发隐藏条件） ---
            {
                id: 'xw_3_lr_2_a_detail',
                title: '懂他',
                background: 'bg-shop',
                dialogues: [
                    { speaker: 'xia_wan', text: '谨言...' },
                    ...
                    { speaker: 'long_xinheng', text: '...' },
                    { speaker: 'narrator', text: '他看着夏晚，眼神里闪过一丝不易察觉的光。' },
                    { speaker: 'long_xinheng', text: '你这家伙...还真是...' },
            ...
            // --- 场景4：单独相处 ---
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'narrator', text: '走到走廊的时候，发现谨言也在。' },
                    { speaker: 'long_xinheng', text: '夏晚？你也出来透气？' },
                    { speaker: 'xia_wan', text: '嗯...里面有点闷。' },
                    { speaker: 'narrator', text: '两人并排站在走廊上，看着远处的夜景。' },
                    { speaker: 'long_xinheng', text: '今天玩得开心吗？' },
                    { speaker: 'xia_wan', text: '嗯，大家在一起很开心。' },
                    { speaker: 'long_xinheng', text: '那就好。' },
                    { speaker: 'narrator', text: '沉默了一会儿。' },
                    { speaker: 'long_xinheng', text: '夏晚...' },
                    { speaker: 'xia_wan', text: '嗯？' },
                    { speaker: 'long_xinheng', text: '谢谢你那天...没有拆穿我。' },
                    { speaker: 'xia_wan', text: '...方圆说的是那天吗？' },
                    { speaker: 'long_xinheng', text: '嗯。' },
                    { speaker: 'narrator', text: '他的声音很轻。' },
                    { speaker: 'long_xinheng', text: '其实那天我确实有点累...' },
                    { speaker: 'long_xinheng', text: '笑久了有时候会忘记自己本来是什么样子。' },
                    { speaker: 'xia_wan', text: '方圆...' },
                    { speaker: 'long_xinheng', text: '但你不一样。' },
                    { speaker: 'xia_wan', text: '？' },
                    { speaker: 'long_xinheng', text: '你好像...能看穿我一样。' },
                    { speaker: 'long_xinheng', text: '让我觉得...被看见了。' },
                    { speaker: 'narrator', text: '他转过头，看着夏晚。' },
                    { speaker: 'long_xinheng', text: '所以...谢谢。' },
                    { speaker: 'xia_wan', text: '（他的眼睛...好亮...）' },
                    { speaker: 'xia_wan', text: '方圆...你不用谢我。' },
                    { speaker: 'xia_wan', text: '我只是...希望方圆也能开心。' },
                    { speaker: 'narrator', text: '谨言愣了一下，然后笑了。' },
                    { speaker: 'long_xinheng', text: '你这个人啊...' },
                    { speaker: 'long_xinheng', text: '真是让人忍不住想靠近。' },
                    { speaker: 'xia_wan', text: '（心跳...好快...）' }
                ],
                choices: [],
                next: 'xw_3_lr_end_choice'
            },
            ...
            // --- 谨言线保持沉默选项 ---
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'long_xinheng', text: '能遇到你这样的学妹...我也很幸运。' },
            ...
            // --- 谨言线转移话题选项 ---
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'xia_wan', text: '那方圆...有没有特别在意的人？' },
                    { speaker: 'long_xinheng', text: '...' },
                    ...
                    { speaker: 'xia_wan', text: '（原来方圆也有这样的经历...）' },
            ...
            // =============================================
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'xia_wan', text: '（...）' },
                    { speaker: 'xia_wan', text: '「方圆今晚怎么这么奇怪。」' },
            ...
            // =============================================
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'xia_wan', text: '（方圆...以后还会对我敞开心扉吗...）' },
            ...
            // =============================================
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'narrator', text: '"木星，你真的很烦。"' },
    ...
    xia_wan_chapter3_ganzhiyu: {
        ...
        scenes: [
            ...
            // --- 场景4_detail：认可他的能力（触发隐藏条件） ---
            {
                id: 'xw_3_gz_4_detail',
                title: '认可',
                background: 'bg-street',
                dialogues: [
                    { speaker: 'xia_wan', text: '方圆真的很厉害的。' },
                    { speaker: 'xia_wan', text: '你讲那些的时候，眼睛里有光。' },
                    { speaker: 'xia_wan', text: '那种感觉...我一直记得。' },
                    { speaker: 'narrator', text: '方圆愣住了。' },
                    { speaker: 'narrator', text: '他看着夏晚，眼神有些复杂。' },
                    { speaker: 'gan_zhiyu', text: '...是吗。' },
                    { speaker: 'gan_zhiyu', text: '我都快忘了。' },
                    { speaker: 'xia_wan', text: '（那一刻，我好像看到了以前的方圆。）' },
                    { speaker: 'xia_wan', text: '（他认真工作的时候...真的很帅。）' }
                ],
                choices: [],
                next: 'xw_3_gz_end_choice'
            },
            ...
            // 方圆线结局3：友情心动
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'xia_wan', text: '（能当一个让他信任的学妹...）' },
            ...
            // --- 方圆线旧结局（已废弃）---
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'narrator', text: '窗外，月光冷清地洒落。' },
                    { speaker: 'xia_wan', text: '（方圆...对不起...）' },
                    { speaker: 'xia_wan', text: '（我好像...把你推开了。）' },
                    { speaker: 'narrator', text: '夏晚闭上眼睛，心里满是遗憾。' },
                    { speaker: 'narrator', text: '她知道，有些错过，就是一辈子。' },
                    { speaker: 'narrator', text: '...' },
                    { speaker: 'narrator', text: '与此同时，方圆躺在床上。' },
                    { speaker: 'gan_zhiyu', text: '（也许...从一开始就是我的错觉。）' },
                    { speaker: 'gan_zhiyu', text: '（而我...想太多了。）' },
                    { speaker: 'narrator', text: '两个人，各怀心事。' },
                    { speaker: 'narrator', text: '却都在沉默中，渐行渐远。' },
                    { speaker: 'narrator', text: '...' },
                    { speaker: 'narrator', text: '夏天已经过去了一半。' },
                    { speaker: 'narrator', text: '而夏晚和方圆之间的关系...' },
                    { speaker: 'narrator', text: '再也回不到从前了。' },
                    { speaker: 'narrator', text: '...' },
                    { speaker: 'narrator', text: '有些遗憾，注定无法弥补。' },
                    { speaker: 'narrator', text: '夏晚线 第三章「心动」 完' }
        ...
        scenes: [
            ...
            // --- 场景1：日常相处 ---
            {
                ...
                dialogues: [
                    { speaker: 'narrator', text: '2025年5月。' },
                    { speaker: 'narrator', text: '夏晚在店里工作已经有一段时间了。' },
                    { speaker: 'narrator', text: '她注意到，吴琊吴琊总是独来独往。' },
            ...
            // --- 场景4：单独相处 ---
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'xia_wan', text: '方圆不出来一起玩吗？' },
                    ...
                    { speaker: 'xia_wan', text: '因为...我觉得方圆一个人待着好像有点孤单。' },
            ...
            // --- 场景4_detail：感受到他的温柔（触发隐藏条件） ---
            {
                ...
                dialogues: [
                    { speaker: 'xia_wan', text: '谢谢方圆...' },
                    { speaker: 'narrator', text: '夏晚的声音很轻，轻得连她自己都有些意外。' },
                    { speaker: 'wu_ya', text: '...' },
                    { speaker: 'narrator', text: '吴琊转过头，看向夏晚的眼神有些不一样了。' },
                    { speaker: 'wu_ya', text: '...不用谢。' },
                    { speaker: 'wu_ya', text: '你...别感冒了。' },
                    { speaker: 'narrator', text: '他说话的时候，眼神有些躲闪。' },
                    { speaker: 'xia_wan', text: '（原来他也会脸红啊...）' },
                    { speaker: 'xia_wan', text: '（这种笨拙的温柔...好可爱。）' },
                    { speaker: 'xia_wan', text: '（我想...一直待在他身边。）' }
                ],
                choices: [],
                next: 'xw_3_wy_end_choice'
            },
...

            {
                ...
                dialogues: [
                    ...
                    { speaker: 'wu_ya', text: '...说。' },
                    { speaker: 'xia_wan', text: '方圆为什么...总是独来独往的？' },
                    { speaker: 'wu_ya', text: '...' },
                    { speaker: 'narrator', text: '吴琊沉默了很久。' },
                    { speaker: 'wu_ya', text: '...不知道怎么和人相处。' },
                    { speaker: 'xia_wan', text: '那方圆...为什么不试试主动一点呢？' },
            ...
            // --- 吴琊线竞争机制：橙子的主动 ---
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'narrator', text: '而吴琊吴琊只是沉默地站在那里。' },
...

            {
                ...
                dialogues: [
                    ...
                    { speaker: 'chengzi', text: '吴琊吴琊，你快看这个～' },
            ...
            // 吴琊线结局2：开放心动
            {
                ...
                dialogues: [
                    { speaker: 'narrator', text: '那天晚上，夏晚躺在床上。' },
                    { speaker: 'narrator', text: '翻看着和吴琊吴琊的聊天记录。' },
            ...
            // 吴琊线结局3：友情心动
            {
                ...
                dialogues: [
                    { speaker: 'narrator', text: '那天晚上，夏晚躺在床上。' },
                    { speaker: 'narrator', text: '想着今天和吴琊吴琊的对话。' },
            ...
            // 吴琊线结局4：遗憾心动
            {
                ...
                dialogues: [
                    ...
                    { speaker: 'narrator', text: '吴琊吴琊还会记得她是谁吗？' },
        ...
        scenes: [
...

            {
                ...
                dialogues: [
                    ...
                    { speaker: 'xia_wan', text: '我看了～方圆是有什么安排吗？' },
                    ...
                    { speaker: 'xia_wan', text: '方圆辛苦了～有什么我能帮忙的一定说！' },
                    { speaker: 'wu_ya', text: '...嗯。' },
                    ...
                    { speaker: 'xia_wan', text: '方圆也是～要注意休息哦' },
                    { speaker: 'wu_ya', text: '...知道了。' },
